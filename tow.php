...
if(isset($_POST['new']) && $_POST['new']==1){
    ...
    if(isset($_POST["submit"])){
      ...
      <script>
        ...
        document.location.href = 'tow.php';
      </script>
      ";
            }
        }
    }
    $ins_query="insert into tow_truck
    ...
    <h3>All Tow-Trucks</h3>
        ...
        <div class="form">
            <table width="100%"  border="1" style="border-collapse:collapse;"class="table table-striped" >
                ...
                <?php
                $count=1;
                $sel_query="Select * from tow_truck ORDER BY id desc;";
